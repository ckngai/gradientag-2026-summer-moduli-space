...
Suggested prerequisite / co-requisite:
- Scheme theory (Hartshorne Chapters 1 and 2)
- Group theory (undergrad level)
- Basic category theory (You should be fairly familiar with the language, e.g. you should know what functors are)

The tentative meeting plan is below.
